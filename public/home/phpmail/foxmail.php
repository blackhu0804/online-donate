...
$mail->Host       = "smtp.foxmail.com";      //必填，设置SMTP服务器
//$mail->Port       = 25;                   // 设置端口

$mail->Username   = "username@foxmail.com";  // 必填，开通SMTP服务的邮箱；任意一个foxmail邮箱均可
$mail->Password   = "password";            //必填， 以上邮箱对应的密码

$mail->From       = "username@foxmail.com";    //必填，发件人Email
...
$mail->AddReplyTo("username@foxmail.com","Webmaster");//回复邮箱地址
