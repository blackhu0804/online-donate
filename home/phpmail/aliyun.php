...
$mail->Host       = "smtp.aliyun.com";      //必填，设置SMTP服务器
//$mail->Port       = 25;                   // 设置端口

$mail->Username   = "amyz666@aliyun.com";  // 必填，开通SMTP服务的邮箱；任意一个126邮箱均可
$mail->Password   = "a132105649356";            //必填， 以上邮箱对应的密码

$mail->From       = "amyz666@aliyun.com";    //必填，发件人Email
...
$mail->AddReplyTo("amyz666@aliyun.com","Webmaster");//回复邮箱地址


//$mail->AddAttachment("/path/to/file.zip");             // 添加附件,注意路径
//$mail->AddAttachment("test/images/phpmailer.png", "new.png"); // 添加附件

$mail->AddAddress($toMail,"First Last");//收件人地址。参数一：收信人的邮箱地址，可添加多个。参数二：收件人称呼
